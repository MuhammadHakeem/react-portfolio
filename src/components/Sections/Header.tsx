...
const Header: FC = memo(() => {
  ...
  const navSections = useMemo(
    () => [SectionId.About, SectionId.TechStack, SectionId.WebAppsInterface, SectionId.MobileInterface, SectionId.Project, SectionId.Contact],
    [],
  );
    ...
    return (
      <>
        <button
          ...
          className="fixed right-2 top-2 z-40 rounded-md bg-green-500 p-2 ring-offset-gray-800/60 hover:bg-green-500 focus:outline-none focus:ring-0 focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2 sm:hidden"
          onClick={toggleOpen}>
