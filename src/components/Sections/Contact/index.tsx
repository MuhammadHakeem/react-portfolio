...
const Contact: FC = memo(() => {
  ...
  return (
    <Section className="bg-neutral-800 h-screen flex items-center" sectionId={SectionId.Contact}>
      <div className="flex flex-col gap-y-6 md:items-center">
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          <div className="flex items-center order-1 col-span-1 flex flex-col gap-y-4 md:order-2">
